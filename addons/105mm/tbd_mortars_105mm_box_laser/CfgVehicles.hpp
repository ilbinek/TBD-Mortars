class CfgVehicles {
    ...
    class TBD_MORTARS_105mm_BOX_LASER : NATO_Box_Base {
        ...
        class ACE_Actions: ACE_Actions {
            ...
            class TBD_TakeMine1 {
                displayName = CSTRING(TAKE_MINE_LASER);
                condition = QUOTE([ARR_2(_target,1)] call FUNC(canTake));
                exceptions[] = {};
                statement = QUOTE([ARR_3(_target,1,QUOTE(QUOTE(TBD_MORTARS_105mm_TUBE_LASER)))] call FUNC(takeMine));
                distance = 2;
            ...
            class TBD_TakeMine2: TBD_TakeMine1 {
                ...
                statement = QUOTE([ARR_3(_target,2,QUOTE(QUOTE(TBD_MORTARS_105mm_TUBE_LASER)))] call FUNC(takeMine));
                selection = "int_mine_2";
            };

            class TBD_PutMine1 {
                displayName = CSTRING(PUT_MINE_LASER);
                condition = QUOTE([ARR_3(_target,1,QUOTE(QUOTE(TBD_MORTARS_105mm_TUBE_LASER)))] call FUNC(canPut));
                exceptions[] = {};
                statement = QUOTE([ARR_3(_target,1,QUOTE(QUOTE(TBD_MORTARS_105mm_TUBE_LASER)))] call FUNC(putMine));
                distance = 2;
                selection = "int_mine_1";
            };

            class TBD_PutMine2: TBD_PutMine1 {
                condition = QUOTE([ARR_3(_target,2,QUOTE(QUOTE(TBD_MORTARS_105mm_TUBE_LASER)))] call FUNC(canPut));
                statement = QUOTE([ARR_3(_target,2,QUOTE(QUOTE(TBD_MORTARS_105mm_TUBE_LASER)))] call FUNC(putMine));
                selection = "int_mine_2";
            };
        };
    };
