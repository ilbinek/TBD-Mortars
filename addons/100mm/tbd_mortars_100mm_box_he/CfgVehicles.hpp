class CfgVehicles {
    ...
    class TBD_MORTARS_100mm_BOX_HE : NATO_Box_Base {
        scope = 2;
		author = "TBD Team";
        displayName = CSTRING(BOX_HE);
        model = QPATHTOF(TBD_MORTARS_100mm_BOX_HE\TBD_MORTARS_100mm_BOX_HE);
        editorPreview = QPATHTOF(TBD_MORTARS_100mm_BOX_HE\data\box.jpg);
        ace_cargo_size = 0.5;
        ace_cargo_canLoad = 1;
