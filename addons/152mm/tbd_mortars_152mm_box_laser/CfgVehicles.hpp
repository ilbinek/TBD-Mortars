class CfgVehicles {
    ...
    class TBD_MORTARS_152MM_BOX_LASER : NATO_Box_Base {
        scope = 2;
		author = "TBD Team";
        displayName = CSTRING(BOX_LASER);
        model = QPATHTOF(TBD_MORTARS_152MM_BOX_LASER\TBD_MORTARS_152MM_BOX_LASER);
        editorPreview = QPATHTOF(TBD_MORTARS_152MM_BOX_LASER\data\box.jpg);
        ace_cargo_size = 0.5;
        ace_cargo_canLoad = 1;
        ...
        class ACE_Actions: ACE_Actions {
            ...
            class TBD_TakeMine2: TBD_TakeMine1 {
                ...
                statement = QUOTE([ARR_3(_target,2,QUOTE(QUOTE(TBD_MORTARS_152MM_ROUND_LASER)))] call FUNC(takeMine));
            ...
            class TBD_PutMine2: TBD_PutMine1 {
                condition = QUOTE([ARR_3(_target,2,QUOTE(QUOTE(TBD_MORTARS_152MM_ROUND_LASER)))] call FUNC(canPut));
                statement = QUOTE([ARR_3(_target,2,QUOTE(QUOTE(TBD_MORTARS_152MM_ROUND_LASER)))] call FUNC(putMine));
                selection = "int_mine_2";
            };
        };
    };
