class CfgVehicles {
    ...
    class TBD_MORTARS_152MM_BOX_HE : NATO_Box_Base {
        scope = 2;
		author = "TBD Team";
        displayName = CSTRING(BOX_HE);
        model = QPATHTOF(TBD_MORTARS_152MM_BOX_HE\TBD_MORTARS_152MM_BOX_HE);
        editorPreview = QPATHTOF(TBD_MORTARS_152MM_BOX_HE\data\box.jpg);
        ace_cargo_size = 0.5;
        ace_cargo_canLoad = 1;
        ...
        class ACE_Actions: ACE_Actions {
            ...
            class TBD_TakeMine2: TBD_TakeMine1 {
                ...
                statement = QUOTE([ARR_3(_target,2,QUOTE(QUOTE(TBD_MORTARS_152MM_ROUND_HE)))] call FUNC(takeMine));
            ...
            class TBD_PutMine2: TBD_PutMine1 {
                condition = QUOTE([ARR_3(_target,2,QUOTE(QUOTE(TBD_MORTARS_152MM_ROUND_HE)))] call FUNC(canPut));
                statement = QUOTE([ARR_3(_target,2,QUOTE(QUOTE(TBD_MORTARS_152MM_ROUND_HE)))] call FUNC(putMine));
                selection = "int_mine_2";
            };
        };
    };
