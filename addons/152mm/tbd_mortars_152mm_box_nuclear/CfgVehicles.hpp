class CfgVehicles {
    ...
    class TBD_MORTARS_152MM_BOX_NUCLEAR : NATO_Box_Base {
        ...
        editorPreview = QPATHTOF(TBD_MORTARS_152MM_BOX_NUCLEAR\data\box.jpg);
        ace_cargo_size = 0.5;
        ace_cargo_canLoad = 1;
        ...
        class ACE_Actions: ACE_Actions {
            ...
            class TBD_TakeMine2: TBD_TakeMine1 {
                ...
                statement = QUOTE([ARR_3(_target,2,QUOTE(QUOTE(TBD_MORTARS_152MM_ROUND_NUCLEAR)))] call FUNC(takeMine));
            ...
            class TBD_PutMine2: TBD_PutMine1 {
                condition = QUOTE([ARR_3(_target,2,QUOTE(QUOTE(TBD_MORTARS_152MM_ROUND_NUCLEAR)))] call FUNC(canPut));
                statement = QUOTE([ARR_3(_target,2,QUOTE(QUOTE(TBD_MORTARS_152MM_ROUND_NUCLEAR)))] call FUNC(putMine));
                selection = "int_mine_2";
            };
        };
    };
